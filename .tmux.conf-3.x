...
#bind F5 movew -r \; display "Reordering..."
...
set-option -g status-style fg=colour34,bg=colour234,bright
#set -g status-bg colour33
#set -g status-fg white

# set window list colors - red for active and cyan for inactive
set-window-option -g window-status-style fg=colour34,bg=colour234,bright
set-window-option -g window-status-current-style fg=white,bg=colour234,bright
...
set -g status-right '#[fg=colour34]| %Y-%m-%d %H:%M '
